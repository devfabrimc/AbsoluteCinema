...
public class Paths {
    // Views Path
    public static final String MENU_VIEW = "/com/absolutecinema/views/client/Menu.fxml";
    ...
    public static final String USER_REPOSITORY = "src/main/resources/com/absolutecinema/data/users.txt";
    public static final String ROOM_REPOSITORY = "src/main/resources/com/absolutecinema/data/rooms.txt";
